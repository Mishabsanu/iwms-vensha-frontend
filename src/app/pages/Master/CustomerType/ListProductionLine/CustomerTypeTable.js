...
export default function CustomerTypeTable({
  ...
  const { customerType, TotalPage, loading } = useSelector(
  ...
  const handleItemAction = (menuItem) => {
    switch (menuItem.action) {
      case "edit":
        navigate("/master/customer-type/edit", { state: menuItem?.data });
        break;
    }
  };
        ...
        <Table size="small">
          <TableHead>
            ...
            >
              ...
              {permissions?.customer_type_master_edit == true && (
                <TableCell
                  sx={{
                    textAlign: "left",
                    color: "white",
                  ...
                  <TableCell sx={{ textAlign: "left" }}>
                    <JumboDdMenu
                      ...
                      menuItems={[
                        {
                          icon: <EditIcon />,
                          title: "Edit Customer Type Details",
                          action: "edit",
                          data: row,
                        },
                      ]}
