...
export const downloadJobWorkIssuedReport = async (inputs) => {
  // console.log(inputs);
  ...
  try {
    ...
    const data = await axios.get(
      `${
      ...
      }/api/challan/job-work-issued-download-excel?order_no=${
        inputs.order_no
        ...
        / /g,
        "+"
      )}&order_item_status=${inputs.order_item_status}&order_port_no_and_name=${
        inputs.order_port_no_and_name
